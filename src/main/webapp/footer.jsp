            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-top-box">
                        ...
                        <ul>
                            <li><a href="https://facebook.com"><i class="fab fa-facebook" aria-hidden="true"></i></a>
                            </li>
                            <li><a href="https://twitter.com"><i class="fab fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="https://linkedin.com"><i class="fab fa-linkedin" aria-hidden="true"></i></a>
                            </li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-widget">
                        ...
                        <p>Đây là project môn Lập trình web, bán trái cây</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-link-contact">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><i class="fas fa-phone-square"></i>Điện thoại: <a href="tel:19005555">1900 5555</a>
                                </p>
                            </li>
                            <li>
...
<div class="footer-copyright">
    <p class="footer-company">All Rights Reserved. &copy; 2018 <a href="#">ThewayShop</a> Thiết kế bởi:
